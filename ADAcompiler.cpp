...
int main(int argc, const char *args[])
{
    if (argc != 3)
    {
        cout << "USAGE: ADAJava option sourceFileName" << endl;
    ...
    switch (mode)
    {
       /* case EXECUTOR:
        {
            // Pass 3: Execute the ADA program.
        ...
        case CONVERTER:
        {
            // Pass 3: Convert from ADA to Java.
...
*/
        case COMPILER:
        {
            // Pass 3: Compile the ADA program.
