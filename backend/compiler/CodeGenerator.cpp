 ...
 */
void CodeGenerator::emitComment(ADAParser::StatementContext *ctx)
{
...
string CodeGenerator::typeDescriptor(Typespec *ADAType)
{
    Form form = ADAType->getForm();
    string descriptor;

    while (form == ARRAY)
    {
        descriptor += "[";
        ADAType =  ADAType->getArrayElementType();
        form = ADAType->getForm();
    }

    ADAType = ADAType->baseType();
    string str;

    if      (ADAType == Predefined::integerType) str = "I";
    else if (ADAType == Predefined::realType)    str = "F";
    else if (ADAType == Predefined::booleanType) str = "Z";
    else if (ADAType == Predefined::charType)    str = "C";
    else if (ADAType == Predefined::stringType)  str = "Ljava/lang/String;";
    else if (form == ENUMERATION)                  str = "I";
    else /* (form == RECORD) */ str = "L" + ADAType->getRecordTypePath() + ";";

    descriptor += str;
    return descriptor;
}

string CodeGenerator::objectTypeName(Typespec *ADAType)
{
    Form form = ADAType->getForm();
    string typeName;
    bool isArray = false;
    ...
    if      (ADAType == Predefined::integerType) str = "java/lang/Integer";
    else if (ADAType == Predefined::realType)    str = "java/lang/Float";
    else if (ADAType == Predefined::booleanType) str = "java/lang/Boolean";
    else if (ADAType == Predefined::charType)    str = "java/lang/Character";
    else if (ADAType == Predefined::stringType)  str = "Ljava/lang/String;";
