...
public:
     ...
     */
    void emitComment(ADAParser::StatementContext *ctx);
    ...
    /**
     * Return a type descriptor for a ADA datatype.
     * @param ADAType the datatype.
     * @return the type descriptor.
     */
    string typeDescriptor(Typespec *ADAType);

    /**
     * Return the Java object name for a ADA datatype.
     * @param ADAType the datatype.
     * @return the object name.
     */
    string objectTypeName(Typespec *ADAType);
