...
void ExpressionGenerator::emitExpression(ADAParser::ExpressionContext *ctx)
{
    ADAParser::SimpleExpressionContext *simpleCtx1 =
...
void ExpressionGenerator::emitSimpleExpression(ADAParser::SimpleExpressionContext *ctx)
{
...
void ExpressionGenerator::emitTerm(ADAParser::TermContext *ctx)
{
...
void ExpressionGenerator::emitNotFactor(ADAParser::NotFactorContext *ctx)
{
...
void ExpressionGenerator::emitLoadValue(ADAParser::VariableContext *varCtx)
{
    ...
    if (modifierCount > 0)
    {
        ADAParser::ModifierContext *lastModCtx =
...
Typespec *ExpressionGenerator::emitLoadVariable(
                                        ADAParser::VariableContext *varCtx)
{
    ...
    {
        ADAParser::ModifierContext *modCtx = varCtx->modifier()[i];
...
Typespec *ExpressionGenerator::emitLoadArrayElementAccess(
                                ADAParser::IndexListContext *indexListCtx,
                                Typespec *elmtType, bool lastModifier)
{
    ...
    {
        ADAParser::IndexContext *indexCtx = indexListCtx->index()[i];
...
void ExpressionGenerator::emitLoadRecordFieldValue(
                    ADAParser::FieldContext *fieldCtx, Typespec *recordType)
{
...
void ExpressionGenerator::emitLoadIntegerConstant(ADAParser::NumberContext *intCtx)
{
    int value = stoi(intCtx->getText());
    emitLoadConstant(value);
}

void ExpressionGenerator::emitLoadRealConstant(ADAParser::NumberContext *realCtx)
{
