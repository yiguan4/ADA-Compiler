...
public:
     ...
     */
    void emitProgram(ADAParser::ProgramContext *ctx);
     ...
     */
    void emitSubprogram(ADAParser::SubprogramBodyContext *ctx);
...
private:
     ...
     */
    void emitSubroutines(ADAParser::SubprogramPartContext *ctx);

    /*
     * Emit code for the program body as the main method.
     * @param *ctx the ProgramContext.
     */
    void emitMainMethod(ADAParser::ProgramContext *ctx);
