 ...
 * <h1>Predefined</h1>
 *
 * <p>Enter the predefined ADA types, identifiers, and constants
...
SymtabEntry *Predefined::putId;
SymtabEntry *Predefined::putLineId;
SymtabEntry *Predefined::getId;
SymtabEntry *Predefined::getLineId;
...
void Predefined::initializeTypes(SymtabStack *symtabStack)
{
    ...
    // Type char.
    charId = symtabStack->enterLocal("character", TYPE);
...
{
    putId      = enterStandard(symtabStack, PROCEDURE, "put",    PUT);
    putLineId  = enterStandard(symtabStack, PROCEDURE, "putLine",  PUTLINE);
    getId      = enterStandard(symtabStack, PROCEDURE, "get",   GET);
    getLineId  = enterStandard(symtabStack, PROCEDURE, "getLine", GETLINE);
