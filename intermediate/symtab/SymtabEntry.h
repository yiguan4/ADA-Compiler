...
constexpr Routine GET          = Routine::GET;
constexpr Routine GETLINE        = Routine::GETLINE;
constexpr Routine PUT         = Routine::PUT;
constexpr Routine PUTLINE       = Routine::PUTLINE;
